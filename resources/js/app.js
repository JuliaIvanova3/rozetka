...
Vue.component('header-first', require('./components/HeaderFirstComponent.vue').default);
Vue.component('header-second', require('./components/HeaderSecondComponent.vue').default);
